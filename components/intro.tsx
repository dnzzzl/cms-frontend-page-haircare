...
export default function Intro( {title, subtitle, image = ''} : IntroProps ) {
  ...
  />
  <div className="md:ml-20 flex-col flex items-center justify-between bg-cover md:bg-transparent px-8 py-8 md:py-16 lg:py-24 xl:py-32 2xl:py-40 mx-0 md:w-1/2 z-20 relative">
